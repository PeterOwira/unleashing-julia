...
# ╔═╡ f1ca0848-34c5-4f4b-8419-5d8ab9f61092
begin
	using DataFrames
	using CSV
end

# ╔═╡ 099fbef8-5154-4118-9955-06682b470064
using Plots  # This will install plots

# ╔═╡ 4af39388-5fe7-45cc-9e47-369f96011840
using PlutoUI

# ╔═╡ 4a2d2129-38c4-4e62-ac36-48866cf2bba0
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 64cd6f16-c04c-4afa-88dd-e0a89bcfea31
df.Country_code === df[!, "Country_code"]

# ╔═╡ 2003233d-ea26-4da6-a644-aa42ed87c7bf
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 077b5696-72e6-43e7-95e9-f445694b77df
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ f0164ecb-c311-46c8-952c-ae502450ea42
dates = sg_data[!, "Date_reported"]

# ╔═╡ c31057af-ff3e-45de-ac51-22ac2567e521
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 9ca9cb0a-7f95-4c22-a7c4-311bb72de9e1
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 4e8b2195-740f-43d2-b841-e0537be190d3
...
# ╔═╡ d19c3f05-1ca8-416d-9d23-69c0b54604ab
@bind slider_value Slider(0:10:1000)

# ╔═╡ e6a0819e-680e-4757-bf3e-d8a87cd23db0
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 88af7fb6-2fc1-4812-9810-5c5d81d90808
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ ef76c4d9-f727-4edc-b22f-18f096992f2a
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 91d66a63-a547-4bf5-bded-7e596a91a58c
